...
import 'package:infrastructure/src/bluetooth/bluetooth_permissions_reader.dart';
...
Future<void> disposeBluetoothStatusService(BluetoothStatusServiceImpl service) => service.dispose();
