...
class FirebaseMessaging extends FirebasePluginPlatform {
  ...
  static Stream<RemoteMessage> get onMessage => FirebaseMessagingPlatform.onMessage.stream;
  ...
  Future<String?> getToken({String? vapidKey, String? serviceWorkerScriptPath}) {
    return _delegate.getToken(vapidKey: vapidKey, serviceWorkerScriptPath: serviceWorkerScriptPath);
  }
