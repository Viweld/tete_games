...
class MessagingExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {'/': (context) => Application(), '/message': (context) => MessageView()},
    );
  }
}
        ...
        actions: <Widget>[
          PopupMenuButton(
            ...
            itemBuilder: (BuildContext context) {
              return [
                const PopupMenuItem(value: 'subscribe', child: Text('Subscribe to topic')),
                const PopupMenuItem(value: 'unsubscribe', child: Text('Unsubscribe to topic')),
                const PopupMenuItem(
