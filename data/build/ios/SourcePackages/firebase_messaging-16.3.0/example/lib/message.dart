                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (notification.android != null) ...[
                        ...
                        const Text('Android Properties', style: TextStyle(fontSize: 18)),
                        ...
                        row('Visibility', notification.android!.visibility.toString()),
                      ],
                      if (notification.apple != null) ...[
                        const Text('Apple Properties', style: TextStyle(fontSize: 18)),
