...
class FirebaseCrashlytics extends FirebasePluginPlatform {
  ...
  Future<void> recordError(
    ...
    // Report error.
    final List<Map<String, String>> stackTraceElements = getStackTraceElements(stackTrace);
  ...
  Future<void> recordFlutterError(FlutterErrorDetails flutterErrorDetails, {bool fatal = false}) {
    ...
    return recordError(
      ...
      reason: flutterErrorDetails.context?.toStringDeep(minLevel: DiagnosticLevel.info).trim(),
