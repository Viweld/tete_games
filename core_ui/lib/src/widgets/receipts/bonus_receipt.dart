...
class BonusReceipt {
  ...
  BonusReceipt._({required this.transaction, required this.styles, required this.logoSvg});
  ...
  static Future<Uint8List> generate(BuildContext extContext, TransactionDetails transaction) async {
    ...
    final BonusReceipt widget = BonusReceipt._(
                ...
                children: <pw.Widget>[
                  ...
                  pw.Text(
                    localization.receipt_pdf_date_external(
                      DateFormat('d MMMM yyyy', 'ru').format(transaction.createdAt),
                              ...
                              pw.ListView.separated(
                                ...
                                itemBuilder: (_, int i) {
                                  ...
                                  return pw.Column(
                                    ...
                                    children: <pw.Widget>[
                                      pw.Text(
                                        _getEndpointTitle(item.type, localization),
                                        style: styles.h5,
                                      ),
                  ...
                  child: pw.Column(
                    ...
                    children: <pw.Widget>[
                      if ((order?.flights ?? <OrderFlight>[]).isNotEmpty)
                        ReceiptSectionCard(
                          title: localization.summary_flight_info_title,
                          styles: styles,
                          child: pw.Column(
                      ...
                      if ((order?.conditions ?? <OrderCondition>[]).isNotEmpty)
                        ReceiptSectionCard(
                          ...
                          child: pw.Column(
                            children: List<pw.Widget>.generate(
                              ...
                              (int i) => pw.Text('${order.conditions[i].value}', style: styles.h6),
                            ),
                          ),
                        ),
                      pw.SizedBox(height: 40 * s),
                            ...
                            if (order.accompanyingPersons.isNotEmpty)
                              pw.Padding(
                                ...
                                child: pw.Column(
                                  children: <pw.Widget>[
                                    pw.Text(
                                      localization.summary_companions_title,
                                      style: styles.h5,
                                    ),
                            ...
                            pw.Column(
                              ...
                              children: <pw.Widget>[
                                ReceiptKeyValueRow(
                                  ...
                                  value: _getStatusText(transaction.status, localization),
                                  styles: styles,
                                ),
                                ReceiptKeyValueRow(
                                  label: localization.receipt_label_date_colon,
                                  value: DateFormat('dd.MM.yyyy').format(transaction.createdAt),
                                  styles: styles,
                                ),
                                ReceiptKeyValueRow(
                                ...
                                if ((transaction.bonusReceipt?.orderCashbackToEarn ?? 0) > 0)
                                  ReceiptKeyValueRow(
                                    ...
                                    value:
                                        '+${transaction.bonusReceipt?.orderCashbackToEarn} (${localization.transaction_card_parameter_accrued_bonuses})',
                                    styles: styles,
                                  ),
                              ],
                            ),
  ...
  String _getEndpointTitle(EndpointType type, AppLocalization localization) => switch (type) {
  ...
  String _getStatusText(TransactionStatus status, AppLocalization localization) => switch (status) {
