...
mixin _$HomeState {
 ...
 bool get isLoading; String? get error; HomeEffect? get effect;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.error, error) || other.error == error)&&(identical(other.effect, effect) || other.effect == effect));
}


@override
int get hashCode => Object.hash(runtimeType,isLoading,error,effect);

@override
String toString() {
  return 'HomeState(isLoading: $isLoading, error: $error, effect: $effect)';
}
...
@useResult
$Res call({
 bool isLoading, String? error, HomeEffect? effect
});
...
/// Create a copy of HomeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? error = freezed,Object? effect = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  String? error,  HomeEffect? effect)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeState() when $default != null:
return $default(_that.isLoading,_that.error,_that.effect);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  String? error,  HomeEffect? effect)  $default,) {final _that = this;
switch (_that) {
case _HomeState():
return $default(_that.isLoading,_that.error,_that.effect);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  String? error,  HomeEffect? effect)?  $default,) {final _that = this;
switch (_that) {
case _HomeState() when $default != null:
return $default(_that.isLoading,_that.error,_that.effect);case _:
  return null;
...
class _HomeState implements HomeState {
  const _HomeState({this.isLoading = false, this.error, this.effect});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeState&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.error, error) || other.error == error)&&(identical(other.effect, effect) || other.effect == effect));
}
...
/// Create a copy of HomeState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? error = freezed,Object? effect = freezed,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( NavigateBackEffect value)?  navigateBack,required TResult orElse(),}){
final _that = this;
switch (_that) {
case NavigateBackEffect() when navigateBack != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( NavigateBackEffect value)  navigateBack,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( NavigateBackEffect value)?  navigateBack,}){
final _that = this;
switch (_that) {
case NavigateBackEffect() when navigateBack != null:
return navigateBack(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  navigateBack,required TResult orElse(),}) {final _that = this;
switch (_that) {
case NavigateBackEffect() when navigateBack != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  navigateBack,}) {final _that = this;
switch (_that) {
case NavigateBackEffect():
return navigateBack();}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  navigateBack,}) {final _that = this;
switch (_that) {
case NavigateBackEffect() when navigateBack != null:
return navigateBack();case _:
  return null;
...
class NavigateBackEffect implements HomeEffect {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NavigateBackEffect);
}
...
@override
String toString() {
  return 'HomeEffect.navigateBack()';
}
